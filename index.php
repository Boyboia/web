                    ...
                    <ul class="header-middle-right-list">
                        ...
                        <li class="header-middle-right-item open" >
                            <div class="cart-icon-menu">
                                ...
                                <span class="count-product-cart">3</span>
                            </div>
                         <a href="history.php"  style=" color: black" > <span>Lịch sử mua hàng</span> </a>
                        </li>
                    </ul>
                </div>
            </div>
                ...
                <div class="widget-row">
                    <div class="widget-row-col-1">
                        ...
                        <div class="widget-row-col-content">
                            <p>Team13's Food là thương hiệu được thành lập vào năm 2025 với tiêu chí đặt chất lượng sản phẩm lên hàng đầu.</p>
                        </div>
    ...
    <div class="copyright-wrap">
        <div class="container">
            <div class="copyright-content">
                <p>Copyright 2025 Team13's Food. All Rights Reserved.</p>
            </div>
        </div>
    </div>
